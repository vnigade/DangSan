...
if ($use_legend && $plotcount > 1) {
    ...
    my $border = 50;
    my $key_box_width = 71; #121; ### XXX DA: reduced size of legend sample boxes
    my $key_box_height = 67; #116; ### XXX DA: reduced size of legend sample boxes
    my $key_text_pre_space = 58; #104; ### XXX DA: reduced space between legend sample box and text
    # this should really be derived from $legend_text_height
    my $key_text_line_space = 98; #157; ### XXX DA: reduced vertical space between legend sample boxes
