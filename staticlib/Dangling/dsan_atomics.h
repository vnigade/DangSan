...
unsigned long dsan_atomic_add(unsigned long *addr, int val)
{
 ...
 */
static inline __attribute__((always_inline))
unsigned long dsan_atomic_cmpxchng(unsigned long *addr, unsigned long desired)
{
...
static inline __attribute__((always_inline))
void dsan_atomic_cmpxchng_once(unsigned long *addr, unsigned long expected, unsigned long desired)
{
