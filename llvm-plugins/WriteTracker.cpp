...
struct WriteTracker : public FunctionPass {
    ...
    WriteTracker() : FunctionPass(ID) { initialized = false; }
    ...
    virtual bool runOnFunction(Function &F) {
        ...
        std::set<const Instruction*> ignoredStores(ignoredGlobalStores);
        ...
        for (auto &bb : F) {
            ...
            for (auto &i : bb) {
                ...
                if (SI && ignoredStores.count(SI) == 0) {tracked++;
        ...
        errs() << "Tracked: " << tracked << "  Untracked: " << untracked << "\n";
